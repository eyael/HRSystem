...
namespace DoctorsPatientWebsite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        DoctorsContext dc = new DoctorsContext();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                { SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString());
                    ...
                    string id = dc.userlist.FirstOrDefault(x => x.userName == model.Email).id;
                    SqlCommand cms = new SqlCommand("update aspnetusers set AccountType='" + accountType + "' where id='" + id + "'", con);
                    con.Open();
                    cms.ExecuteNonQuery();
                    con.Close();
